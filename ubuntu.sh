...
wget http://cdimage.ubuntu.com/ubuntu-base/daily/pending/${UBUNTU_VERSION}-base-${ARCHITECTURE}.tar.gz -q -O ubuntu.tar.gz 
...
command+=" -k 6.5.3-arm64-MrPurple-SHADOW-v死_Android"
